...
func (d *linstor) commonVolumeRules() map[string]func(value string) error {
	return map[string]func(value string) error{
		// gendoc:generate(entity=storage_volume_linstor, group=common, key=block.filesystem)
		//
		// ---
		//  type: string
		...
		// gendoc:generate(entity=storage_volume_linstor, group=common, key=block.mount_options)
		//
		// ---
		//  type: string
		//  condition: block-based volume with content type `filesystem`
		...
		// gendoc:generate(entity=storage_volume_linstor, group=common, key=drbd.auto_diskful)
		//
		// ---
		//  type: string
		//  condition: -
		...
		// gendoc:generate(entity=storage_volume_linstor, group=common, key=drbd.auto_add_quorum_tiebreaker)
		//
		// ---
		//  type: bool
		//  condition: -
		...
		// gendoc:generate(entity=storage_volume_linstor, group=common, key=linstor.remove_snapshots)
		//
		// ---
		//  type: bool
		//  condition: -
...
func (d *linstor) ValidateVolume(vol Volume, removeUnknownKeys bool) error {
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=initial.gid)
	//
	// ---
	//  type: int
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=initial.mode)
	//
	// ---
	//  type: int
	//  condition: custom volume with content type `filesystem`
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=initial.uid)
	//
	// ---
	//  type: int
	//  condition: custom volume with content type `filesystem`
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=security.shared)
	//
	// ---
	//  type: bool
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=security.shifted)
	//
	// ---
	//  type: bool
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=security.unmapped)
	//
	// ---
	//  type: bool
	//  condition: custom volume
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=size)
	//
	// ---
	//  type: string
	//  condition: -
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=snapshots.pattern)
	//
	// ---
	//  type: string
	//  condition: custom volume
	...
	// gendoc:generate(entity=storage_volume_linstor, group=common, key=snapshots.schedule)
	//
	// ---
	//  type: string
	//  condition: custom volume
