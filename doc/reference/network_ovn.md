...
Instead of creating a logical router of its own, the child attaches its own logical switch and subnet to the logical router of its parent:
    ...
    incus network create net1 --type=ovn network=UPLINK ipv4.address=192.168.0.1/24
    incus network create net2 --type=ovn parent=net1 ipv4.address=192.168.1.1/24
    incus launch images:ubuntu/22.04 vm1 --network net2
